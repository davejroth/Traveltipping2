...
<?php echo $this->Form->create('DealType');?>
	<fieldset>
 		<legend><?php __('Admin Edit Deal Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('DealType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('DealType.id'))); ?></li>
