<div  class="white_mod_246_wrap">
	...
	<div class="white_mod_246_content clearfix">
		...
		to send us an email at <a href=mailto:support@traveltipping.com> support@traveltipping.com </a></p>
		<p class="last"> You can still view the contact details and travel tips for any upcoming trip by clicking on the <strong>View Page </strong> button.</p>
		</div>
	</div>
</div>