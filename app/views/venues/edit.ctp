...
<?php echo $this->Form->create('Venue');?>
	<fieldset>
		<legend><?php __('Edit Venue'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Venue.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Venue.id'))); ?></li>
