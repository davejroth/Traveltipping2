	...
	<?php echo $this->Form->create('Merchant', array('url' => '/merchants/approve/' . $deal['Deal']['id'],'id'=>'ApprovalForm'));?>
		<p class="sub_heading">Please approve your deal </p>
			<div class="legal_approval">
				...
				<p>The Supplier is responsible for providing its own separate terms of service that govern their usage of the business being advertised.
				</p>
				<p>Supplier agrees to hold TravelTipping Inc. harmless from any claims or expenses whether brought by any Guest or by a third party related to a breach of any of the terms stated in this document.
				</p>
				<p>Supplier accounts are not transferable, assignable or resalable without express written consent from TravelTipping Inc.
				</p>
				<p>This Agreement does not constitute a partnership or joint venture between TravelTipping Inc. and the Supplier.
				</p>
				<p>The language of this Agreement shall be English and in the event of a conflict of interpretation by any other language, the English language shall prevail in jurisdiction.
				</p>
				<p>Supplier&#8217;s failure to perform under this Agreement by reason of the following shall not be considered a breach of Terms: war, work stoppage, fire, weather events, air carrier interruption, or act of government. A Supplier that cannot perform under this Agreement as a result of such an unforeseeable event shall notify TravelTipping Inc promptly.
				</p>
