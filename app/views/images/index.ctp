<div class="images index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('is_copyrighted');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($image['Merchant']['business_name'], array('controller' => 'merchants', 'action' => 'view', $image['Merchant']['id'])); ?>
		</td>
		<td><?php echo $image['Image']['is_copyrighted']; ?>&nbsp;</td>
		<td class="actions">
