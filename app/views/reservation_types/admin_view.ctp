...
<h2><?php  __('Reservation Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $reservationType['ReservationType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $reservationType['ReservationType']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $reservationType['ReservationType']['modified']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $reservationType['ReservationType']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Reservation Type', true), array('action' => 'edit', $reservationType['ReservationType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Reservation Type', true), array('action' => 'delete', $reservationType['ReservationType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $reservationType['ReservationType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Reservation Types', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Reservation Type', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($reservationType['Deal'])):?>
	...
	<?php
		$i = 0;
		foreach ($reservationType['Deal'] as $deal):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
